  ...
  return (
    <main className="legal-page">
      <section className="legal-document" aria-labelledby="terms-title">
        ...
        <p>
          These Terms and Conditions govern your access to and use of Pramania,
        ...
        <p>
          ...
          Pramania, you confirm that you have read, understood, and agree to these
        ...
        <p>
          ...
          any action you take based on Pramania&apos;s output. You must review,
        ...
        <p>
          Pramania does not guarantee interviews, job offers, employment,
          ...
          many factors outside Pramania&apos;s control.
        </p>

        <h2>4. AI-Generated Content</h2>
        <p>
          Pramania uses artificial intelligence and automated processing. AI output
        ...
        <p>
          Pramania provides software-assisted career support. It does not provide
        ...
        <p>
          Pramania may process links, files, or content from third-party websites
          ...
          you submit to Pramania.
        </p>

        <h2>7. User Content and License</h2>
        <p>
          You retain ownership of content you provide. You grant Pramania a
        ...
        <p>
          You may not use Pramania to break the law, misrepresent your identity or
        ...
        <p>
          Pramania may be updated, changed, interrupted, suspended, or discontinued
        ...
        <p>
          Pramania is provided &quot;as is&quot; and &quot;as available&quot; without
        ...
        <p>
          To the maximum extent permitted by law, Pramania and its owners,
        ...
        <p>
          ...
          dissatisfaction with Pramania is to stop using the service.
        </p>

        <h2>13. Indemnity</h2>
        <p>
          You agree to defend, indemnify, and hold harmless Pramania and its
        ...
        <p>
          We may update these Terms from time to time. Continued use of Pramania
          after changes become effective means you accept the updated Terms.
        </p>

        <h2>15. Contact</h2>
        <p>
          For questions about these Terms, contact the Pramania operator through
