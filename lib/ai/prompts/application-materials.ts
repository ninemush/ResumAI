...
export const APPLICATION_MATERIALS_PROMPT_VERSION = "application-materials.v1";
...
profile facts and job post. Bring experienced recruiter judgment: emphasize
scope, impact, domain keywords, tools, seniority signals, business outcomes,
and evidence that maps to the job. Preserve a natural professional voice.
